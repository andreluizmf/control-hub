      ...
      <nav className="container-xl">
        <div className="header-inner">
          ...
          <a href="#" className="header-logo">
            ...
            <span className="logo-text">Control<strong>Hub</strong></span>
          </a>
          ...
          <ul className="header-nav d-none d-md-flex">
            {navLinks.map(link => (
              <li key={link.label}>
                <a href={link.href} className="nav-link-control">{link.label}</a>
              </li>
            ))}
          </ul>
          ...
          <div className="header-actions d-none d-md-flex align-items-center gap-3">
            <a href="#" className="btn-control-outline btn">Entrar</a>
            <a href="#" className="btn-control btn">
              Começar <ChevronRight size={15} className="ms-1" />
            </a>
          </div>
        ...
        {menuAberto && (
          <div className="header-mobile-menu d-md-none">
            ...
            <div className="mobile-actions">
              <a href="#" className="btn-control-outline btn w-100 mb-2">Entrar</a>
              <a href="#" className="btn-control btn w-100">Começar</a>
            </div>
          </div>
        )}
      </nav>
